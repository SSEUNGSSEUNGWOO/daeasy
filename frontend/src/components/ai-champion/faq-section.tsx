...
const FAQ = [
  ...
  },
  {
    ...
    a: "인증 방식은 세 가지입니다. 교육과정형은 종합과정을 수강하고 수행평가로 인증받습니다. 자기주도형은 민간교육이나 자기주도학습으로 역량을 갖춘 사람이 종합과정 없이 수행평가만 치릅니다. 자격연계형은 AICE Associate·ADP·빅데이터분석기사 중 하나를 보유하고 행안부 지정 과목 1개 이상을 이수하면 Blue 등급이 부여됩니다. 수행평가는 생성형 AI 활용 30점·데이터 분석 30점·서비스 구현 40점으로 구성되며, 합산 75점 이상이면 인증됩니다. 미인증 시 월별 정기평가 일정 안에서 재응시할 수 있습니다.",
  },
  {
