...
const FAQ = [
  ...
  },
  {
    ...
    a: "인증 방식은 세 가지입니다. 교육과정형은 종합과정을 수강하고 수행평가로 인증받습니다. 자기주도형은 민간교육이나 자기주도학습으로 역량을 갖춘 사람이 종합과정 없이 수행평가만 치릅니다. 자격연계형은 AICE Associate·ADP·빅데이터분석기사 중 하나를 보유하고 행안부 지정 과목 1개 이상을 이수하면 Blue 등급이 부여됩니다. 수행평가는 생성형 AI 활용·데이터 분석·서비스 구현 각 30점으로 구성되며, 합산 75점 이상이면 인증됩니다. 미인증 시 재응시할 수 있습니다.",
  },
  {
    q: "누가 신청할 수 있고, 어디서 신청하나요?",
    a: "공무원과 공공기관 직원이 대상입니다. 신청은 행안부·NIA 역량강화 학습지원시스템(databus.kr)의 수강신청 메뉴에서 합니다. 매월 모집 공지가 올라오며, 종합과정과 자기주도형 수행평가 모두 선수과목 2과목 이수가 신청 조건입니다. 기관 단위 교육 설계나 운영 상담은 데이지에 문의하시면 됩니다.",
  },
  {
